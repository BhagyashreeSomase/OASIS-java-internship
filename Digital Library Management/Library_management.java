...
public class Library_management extends JFrame implements ActionListener {
    ...
    public Library_management() {
        ...
        label1 = new JLabel("Book Identification No");
        label2 = new JLabel("Book Title");
        label3 = new JLabel("Author Name");
        label4 = new JLabel("Publisher Name");
        label5 = new JLabel("Year of Publication");
        label6 = new JLabel("Entry");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addButton) {
            ...
            String[] columns = { "Book Identification No", "Book Title", "Author Name", "Publisher Name",
                    "Year of Publication", "Entry",
                    "Number of Copies" };
